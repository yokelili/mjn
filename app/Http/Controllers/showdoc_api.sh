...
#
api_key="c92ff31449883a5b78f28cbcf200e20f1423621788" 			#api_key
api_token="e05928b056b2be18a95cf2cce233f8091803655118" 	#api_token
url="https://apidoc.haoqianlei.com/server/?s=/api/open/fromComments" #同步到的url。使用www.showdoc.com.cn的不需要修改，使用私有版的请修改
#
#
#
#
